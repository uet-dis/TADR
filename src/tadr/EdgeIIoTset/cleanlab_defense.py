...
def resolve_repo_path(path_text: str) -> Path:
    ...
    candidates = [
        ...
        SRC_ROOT / path,
        SRC_ROOT / "src" / "tadr" / "EdgeIIoTset" / path,
        SRC_ROOT / "src" / "tadr" / path,
    ]
...
def main() -> None:
    ...
    parser.add_argument(
        "--input", "-i",
        type=str,
        default="src/tadr/EdgeIIoTset/resources/edgeiot/clean_merged/edgeiot_train_clean_merged_noise_30.csv"
    )
