"""
Benchmark SOTA KNN defense for IDS18.
...
def main() -> None:
    ...
    parser = argparse.ArgumentParser(description="Benchmark SOTA KNN defense for IDS18")
    ...
    if not knn_script.exists() or not training_script.exists():
        raise SystemExit("Required script not found (knn_label_sanitization.py/model_training.py)")
    ...
    print("=" * 100)
    print("[DONE] SOTA KNN BENCHMARK COMPLETED (IDS18)")
