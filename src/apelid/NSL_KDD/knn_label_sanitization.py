"""
KNN label sanitization defense for NSL_KDD / CIC-like encoded datasets.
...
from apelid.configs import CIC2018Resources, NSLKDDResources
...
def resolve_repo_path(path_text: str) -> Path:
    ...
    candidates = [
        ...
        PROJECT_ROOT / path,
        PROJECT_ROOT / "src" / "apelid" / "NSL_KDD" / path,
...
def main() -> None:
    ...
    parser.add_argument("--input", "-i", type=str, default="src/apelid/NSL_KDD/resources/NSLKDD/clean_merged/nslkdd_train_clean_merged_noise_a2b_20_b2a_0.csv")
    parser.add_argument("--output", "-o", type=str, default=None)
    parser.add_argument("--report", type=str, default=None)
    parser.add_argument("--resource", "-r", type=str, default="nslkdd", choices=list(REGISTRY.keys()))
