"""
Auto ablation runner for NSL-KDD data-poisoning pipeline.
...
def main() -> None:
    ...
    default_clean_input = script_dir / "resources" / "NSLKDD" / "clean_merged" / "nslkdd_train_clean_merged.csv"

    parser = argparse.ArgumentParser(description="Auto ablation pipeline runner for NSL-KDD")
    ...
    parser.add_argument("--clean-input", type=str, default=str(default_clean_input), help="Path to the clean NSL-KDD training CSV")
