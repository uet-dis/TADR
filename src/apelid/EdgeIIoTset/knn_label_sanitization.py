"""
KNN label sanitization defense for EdgeIIoTset.
...
def main() -> None:
    ...
    parser = argparse.ArgumentParser(description="Multi-class KNN label sanitization defense for EdgeIIoTset")
    parser.add_argument("--input", "-i", type=str, default="src/apelid/EdgeIIoTset/resources/edgeiot/clean_merged/edgeiot_train_clean_merged_noise_30.csv")
    parser.add_argument("--output", "-o", type=str, default=None)
    parser.add_argument("--report", type=str, default=None)
    parser.add_argument("--resource", "-r", type=str, default="edgeiot", choices=["edgeiot"])
    parser.add_argument("--num-encoder", "-n", type=str, default="minmax", choices=["minmax", "quantile_uniform"])
    parser.add_argument("--k", type=int, default=15)
    parser.add_argument("--eta", type=float, default=0.5)
    parser.add_argument("--only-benign", action="store_true", help="Only sanitize rows currently labeled as Normal")
